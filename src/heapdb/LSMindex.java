...
public class LSMindex {
	...
	public int lookup(Object key) {
		...
		throw new UnsupportedOperationException("LSMindex lookup method needs to be implemented.");
	}
	...
	public void insertEntry(Object key, int blockno) {
		...
		throw new UnsupportedOperationException("LSMindex insertEntry method needs to be implemented.");
	}
	...
	public void createIndexTree() {
		...
		// 
		throw new UnsupportedOperationException("LSMindex createIndexTree method needs to be implemented.");
	}
